...
> **ADR References:** [ADR-0022: Offline BPE Token Accounting via `tiktoken`](../adr/0022-offline-bpe-token-accounting.md), [ADR-0023: Async Local Model Bridge via `httpx`](../adr/0023-async-local-model-bridge.md)  
