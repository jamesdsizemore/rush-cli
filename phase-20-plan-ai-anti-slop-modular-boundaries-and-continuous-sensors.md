...
> **ADR References:** [ADR-0011: HTML and SARIF Artifact Export](docs/adr/0011-html-and-sarif-artifact-export.md), [ADR-0012: Pluggable LLM Provider Abstraction](docs/adr/0012-pluggable-llm-provider-abstraction.md), [ADR-0013: TDD Guard and Continuous Architectural Sensors](docs/adr/0013-tdd-guard-and-continuous-architectural-sensors.md)  
