...
> **ADR References:** [ADR-0003: Tool Catalog CLI MCP Parity](docs/adr/0003-tool-catalog-cli-mcp-parity.md), [ADR-0024: Hardened Subprocess Git Invocations](docs/adr/0024-hardened-subprocess-git-invocations.md)  
