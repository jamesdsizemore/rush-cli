...
| ISS-PROGRAM-GATES | P3–P5 required benchmark gate records are absent or inconsistent | Open | Critical — later context, coordination, and provider work is forbidden until evidence is reconciled | P2-T02 | `BG-PRIV` and `BG-AUTH` are now committed; historical handoff links are explicitly non-canonical. `BG-CTX`, `BG-COORD`, and route records remain absent. | Phase 3–5 schemas and approved provider routes | Program owner | Blocks P3–P5; does not block P2 | Reconcile committed decision records, exact gate IDs, and OmniRoute naming before each phase begins | BL-P3-00, BL-P4-00, BL-P5-00 | Gate-record audit before each phase T00 | No deferral decision recorded |
