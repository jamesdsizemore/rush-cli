...
> **ADR References:** [ADR-0016: Local Web Dashboard and Rich Interactive TUI](docs/adr/0016-local-web-dashboard-and-rich-interactive-tui.md), [ADR-0024: Hardened Subprocess Git Invocations](docs/adr/0024-hardened-subprocess-git-invocations.md)  
