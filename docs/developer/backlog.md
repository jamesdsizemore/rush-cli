...
| BL-P2-00 | Provenance-aware handoff | Complete | P0 | P2 | P2-T00–P2-T02 | P1 commit; BG-PRIV; BG-AUTH | Gives a resumed agent redacted, authority-labelled evidence | P2-T01 produced authority evidence before receipt integration | ISS-BG-AUTH, ISS-BG-PRIV, ISS-P2-00 | None | P2 commit |
| BL-P2-01 | Authority/redaction evidence contract | Complete | P0 | P2 | P2-T01 | BL-P2-00; BG-PRIV | Prevents historic instructions and secrets from becoming active handoff state | Required before receipt integration | BG-AUTH generated from P2-T01 red/green evidence | ISS-BG-AUTH, ISS-BG-PRIV | P2 commit |
| BL-P2-02 | Inspectable handoff receipts | Complete | P0 | P2 | P2-T02 | BL-P2-01; BG-AUTH pass | Gives user and MCP bounded goal/frontier/failure evidence | Required restore outcome without a completion claim | None | ISS-BG-AUTH | P2 commit |
| BL-P3-00 | Grounded context envelope | Complete | P0 | P3 | P3-T00–P3-T03 | P2 commit; BG-CTX | Gives agents bounded selected context and recovery handles | Context envelope semantics require an approved gate | ISS-PROGRAM-GATES, ISS-BG-CTX | P3 direct red/green tests prove envelope, safe omission, recovery, and CLI/MCP transport parity | P3 commit |
| BL-P4-00 | Coordination and recovery evidence | Complete | P0 | P4 | P4-T00–P4-T03 | P3 commit; BG-COORD | Prevents silent ownership conflicts and stale recovery | New coordination semantics require an approved gate | ISS-PROGRAM-GATES, ISS-BG-COORD | Stale-lock, merge-conflict, missing/corrupt replay, and redacted failure-receipt tests pass; no automatic recovery exists | P4 completion commit |
