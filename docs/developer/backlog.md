...
| BL-P5-03 | OmniRoute CLI/API resume contract | Active | P0 | P5 | P5-T02 | BL-P5-00; concrete CLI/API request/response contract | Makes the enabled OmniRoute CLI/API usable through a bounded redacted adapter | Credentialed local API handoff requires route-specific authorization and protocol test | ISS-P5-OMNIROUTE | CLI/API adapter, timeout, redaction, and local protocol tests pending | Pending |
| BL-P5-04 | P5 documentation and tracker reconciliation | Active | P0 | P5 | P5-DOC, P5-BI | BL-P5-01–P5-03 | Keeps route availability, safety boundaries, and status truthful | Cannot close while enabled router routes are unimplemented | ISS-P5-DOC-SCOPE | Required P5 doc pack updated; final audit waits on P5 routes | Pending |
