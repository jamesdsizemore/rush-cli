...
| BL-P5-00 | Approved provider interoperability | Active | P0 | P5 | P5-T00–P5-T03 | P4 completion; route-specific evidence reconciliation | Lets users deliberately select only validated provider/CLI routes | Existing benchmark routes must be corrected and verified per route | ISS-PROGRAM-GATES | Fixtures and local B-D07–B-D10 records exist but are inconclusive; start capability/fixture repair, keep live routes individually gated | N/A |
