...
| BL-P4-00 | Coordination and recovery evidence | Ready | P0 | P4 | P4-T00–P4-T03 | P3 commit; BG-COORD | Prevents silent ownership conflicts and stale recovery | New coordination semantics require an approved gate | ISS-PROGRAM-GATES, ISS-BG-COORD | P3 is merged and BG-COORD is a narrow local baseline; direct P4 tests remain required | Gate reconciliation commit |
