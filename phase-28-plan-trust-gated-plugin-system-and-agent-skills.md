...
> **ADR References:** [ADR-0015: Extensible Plugin Architecture and Agent Skills](docs/adr/0015-extensible-plugin-architecture-and-agent-skills.md), [ADR-0024: Hardened Subprocess Git Invocations](docs/adr/0024-hardened-subprocess-git-invocations.md)  
