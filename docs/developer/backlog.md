...
| **Phase 42** | TOON, AST Skeletons & Ship Gate | `rush ship gate/migration/semver/pack`, TOON v4.1, Polyglot AST Skeletons, Merkle | Complete | ADR-0031, 0037, 0039, 0046 |
| **Phase 43** | CCR, Grounding & Mistake Memory | `rush context retrieve`, `rush hallu-guard`, `rush context mistakes`, FailureLedger | In Progress | ADR-0030, 0033, 0038, 0041, 0042 |
