...
> **ADR References:** [ADR-0018: Closed-Loop AI Agent Patch Remediation and Session Memory](docs/adr/0018-closed-loop-ai-agent-patch-remediation-and-session-memory.md), [ADR-0020: Cryptographic HMAC Context Boundary Framing](docs/adr/0020-cryptographic-hmac-context-boundary-framing.md), [ADR-0024: Hardened Subprocess Git Invocations](docs/adr/0024-hardened-subprocess-git-invocations.md)  
