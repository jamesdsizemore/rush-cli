...
No port opens. Rush does not become a background network daemon. Configure a client using [MCP client setup](mcp-client-setup.md), then use prompts from [Working with AI agents](../user-guide/working-with-ai-agents.md).
