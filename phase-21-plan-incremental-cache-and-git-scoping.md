...
> **ADR References:** [ADR-0014: Incremental Content-Hash Result Caching and Git Scoping](docs/adr/0014-incremental-content-hash-result-cache.md), [ADR-0024: Hardened Subprocess Git Invocations](docs/adr/0024-hardened-subprocess-git-invocations.md)  
