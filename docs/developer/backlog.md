...
| BL-P4-00 | Coordination and recovery evidence | Active | P0 | P4 | P4-T00–P4-T03 | P3 commit; BG-COORD | Prevents silent ownership conflicts and stale recovery | New coordination semantics require an approved gate | ISS-PROGRAM-GATES, ISS-BG-COORD | Shared conflict receipt and failure-safe evidence tests are in progress | Pending P4 commit |
