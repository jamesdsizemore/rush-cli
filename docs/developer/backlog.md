...
| BL-P3-00 | Grounded context envelope | Ready | P0 | P3 | P3-T00–P3-T03 | P2 commit; BG-CTX | Gives agents bounded selected context and recovery handles | Context envelope semantics require an approved gate | ISS-PROGRAM-GATES, ISS-BG-CTX | P2 is merged and `BG-CTX` is a narrow deterministic baseline; P3 direct contract tests remain required | Gate reconciliation commit |
