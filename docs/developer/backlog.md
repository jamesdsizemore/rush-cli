...
| BL-P5-02 | 9Router CLI/gateway resume contract | Active | P0 | P5 | P5-T02 | BL-P5-00; concrete gateway request/response contract | Makes the installed 9Router CLI/gateway usable without treating `--help` as success | Gateway profile/protocol is not implemented in continuity | ISS-P5-9ROUTER | Benchmark requires a real gateway response; continuation adapter tests pending | Pending |
