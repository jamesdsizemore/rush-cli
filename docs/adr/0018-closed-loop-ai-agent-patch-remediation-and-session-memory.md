...
Session Memory Ledger and CAS Map Transaction memory-storage specifics (Phase 58
Architecture section below); the patch-remediation decisions remain in force.
Accepted
